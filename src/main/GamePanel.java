...
public class GamePanel extends Canvas {
    ...
    private void setupScreenSize(int width, int height) {
     ...
     public void initLevelUpChoices() {
        ...
        levelUpChoices.add(new LevelUpChoice("Spinning Sword", LevelUpChoice.ADD_WEAPON, new SpinningSword(game, 100, 100, 1, 300, 100, player), player));
        levelUpChoices.add(new LevelUpChoice("Aura", LevelUpChoice.ADD_WEAPON, new Aura(game, 150, 150, 0.5f, 300, player), player));
